  ...
  return (
    <div id='app' className='app' aria-label='app' data-test-id='app'>
      <AppDataProvider>
        ...
        <DatePicker lower_bound='2015-07-14' upper_bound='2035-06-27' missing_dates={['2023-01-10','2023-01-20','2023-01-21','2023-01-22','2023-01-24']} first_day_of_week={0} only_select_a_date={false}/>
      </AppDataProvider>
    </div>
  );
}